...
ACIA_INIT_WORD EQU (ACIA_CTRL_CLKDIV_64 | ACIA_CTRL_SEL_8N1 | ACIA_CTRL_XMIT_RTS_LOW_TX_INT_DIS | ACIA_CTRL_RX_INT_DIS)
...
STARTUP_MSG FCB "ROMMON v1 Jason Alexander",CR,NL,0
...
MONITOR_IDENT_MSG FCB "ROMMON v1 6809 ROM monitor, 2019-2024 by daveho hacks, Jason Alexander",CR,NL,0
